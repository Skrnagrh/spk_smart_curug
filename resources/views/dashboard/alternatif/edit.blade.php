...
@section('page-title', 'Alternatif Ubah')
        ...
        <div class="col-12">
            <div class="card m-0 border shadow-sm px-3">
                <div class="d-flex align-items-center justify-content-between">
                    <h5 class="mt-3"><i class="bi bi-pencil-square"></i> Ubah Data Alternatif</h5>
                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="code_curug"
                                                        ...
                                                        name="code_curug" required value="{{ $alternatif->code_curug }}"
                                                        placeholder="Kode Air Terjun" readonly
                                                        style="background: var(--bs-bg-body)">
                                                    @error('code_curug')
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="name_curug"
                                                        ...
                                                        name="name_curug" required value="{{ $alternatif->name_curug }}"
                                                        placeholder="Nama Air Terjun" autofocus>
                                                    @error('name_curug')
                                                    @include('layouts.partial.invalid-form', ['message' =>
                                                    $message])
                                                    @enderror
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <img src="{{ asset('storage/' . $alternatif->image) }}"
                                                    class="img-preview img-fluid mb-3 col-md-12 d-block">
                                                @else
                                            ...
                                            <div id="hidden-div" style="display:none;">
                                                <div class="col-12">
                                                    <label for="description" class="form-label">Deskripsi Air
                                                        Terjun</label>
                                                    @error('description')
                                                    <p class="text-danger">{{ $message }}</p>
                                                    @enderror
                                                    <input id="description" type="hidden" name="description" required
                                                        value="{{ old('description', $alternatif->description ) }}">
                                                    <trix-editor input="description" placeholder="Deskripsi Air Terjun">
                                                    </trix-editor>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="time" id="waktu_awal" class="form-control"
                                                                name="waktu_awal" step="1800"
                                                                value="{{ $alternatif->waktu_awal }}">
                                                            <span class="input-group-text">-</span>
                                                            <input type="time" id="waktu_akhir" class="form-control"
                                                                name="waktu_akhir" step="1800"
                                                                value="{{ $alternatif->waktu_akhir }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="nohp"
                                                            ...
                                                            name="nohp" value="{{ $alternatif->nohp }}"
                                                            placeholder="No. Hp Pengelola" pattern="[0-9]+"
                                            ...
                                            <div class="col-12 d-flex justify-content-end">
                                                <a href="{{ route('alternatif.index') }}"
                                                    class="btn btn-secondary me-1 mb-1 btn-sm"><i
